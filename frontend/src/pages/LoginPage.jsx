            ...
            <motion.div
                ...
                <form onSubmit={submit} className="space-y-4">
                    {mode === 'register' && (
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-white/20 bg-white/10 px-4 py-2.5
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-white/20 bg-white/10 px-4 py-2.5 pr-10
                                       text-sm text-white placeholder-gray-500 focus:outline-none
                                       focus:border-purple-500 transition"
                            placeholder="••••••••" />
                    ...
                    <button
                        ...
                        {mode === 'login' ? <><LogIn size={16}/> Sign In</> : <><UserPlus size={16}/> Register</>}
                    </button>
                </form>
                ...
                <button
                    ...
                    className="w-full py-2.5 rounded-xl border border-white/20 bg-white/5
                               hover:bg-white/10 text-sm text-gray-300 transition flex items-center
                    ...
                    {mode === 'login' ? (
                        <>No account?{' '}
                            <button onClick={() => setMode('register')}
                                    className="text-purple-400 hover:underline">Register</button></>
                    ) : (
                        <>Have an account?{' '}
